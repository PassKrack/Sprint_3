...
class TestStellarBurgers:
    ...
    def test_success_go_to_the_personal_account_page(self,driver, login):
    ...
    def test_success_routing_from_personal_account_by_logo(self,driver, login):
        Steps.click_to_element(driver, PERSONAL_ACCOUNT_LOCATOR)
        Steps.wait_element(driver, AUTH_FORM_TITLE_LOCATOR)
    ...
    def test_success_routing_from_personal_account_by_constructor(self, driver, login):
        Steps.click_to_element(driver, PERSONAL_ACCOUNT_LOCATOR)
        Steps.wait_element(driver, AUTH_FORM_TITLE_LOCATOR)
