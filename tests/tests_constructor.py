...
class TestStellarBurgers:
    ...
    def test_success_rolls_chapter_selected(self, driver, login):
    ...
    def test_success_sauces_chapter_selected(self, driver, login):
        Steps.wait_element(driver, MAIN_MENU_TITLE_LOCATOR)
        Steps.click_to_element(driver, SAUCES_CHAPTER_LOCATOR)
        Steps.wait_element(driver,INDICATION_SELECT_LOCATOR)
    ...
    def test_success_fillings_chapter_selected(self, driver, login):
        Steps.wait_element(driver, MAIN_MENU_TITLE_LOCATOR)
